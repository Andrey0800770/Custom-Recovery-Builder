...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/star2qltechn/prebuilt/Image.gz-dtb
...
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/star2qltechn/bootimg.mk
...
TW_USES_SYSTEM_AS_ROOT := true
TW_SYSTEM_MOUNT_POINT := /system_root
